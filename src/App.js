...
class App extends Component {
  render() {
    return ( <
      ...
      /> <
      Route exact path = {
        `${Constants.CONFIRM_REGISTRATION_URL}/${Constants.TOKEN_PATH_VARIABLE}`
      }
      component = {
      ...
      /> <
      Route exact path = {
        `${Constants.ACCOUNT_ACTIVATED_URL}`
      }
      component = {
        AccountActivated
      }
      /> <
      Route exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
        ComputerBuildDetail
      }
      ...
      /> <
      SecuredRoutes exact path = {
        `${Constants.CHANGE_PASSWORD_URL}/${Constants.TOKEN_PATH_VARIABLE}`
      }
      component = {
      ...
      /> <
      SecuredRoutes exact path = {
        `${Constants.CREATE_COMPUTER_BUILD_URL}`
      }
      component = {
        AddComputerBuild
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}${Constants.CREATE_COMPUTER_PART_URL}`
      }
      component = {
        AddComputerPart
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.UPDATE_COMPUTER_PART_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}/${Constants.UNIQUE_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
        EditComputerPart
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}${Constants.CREATE_DIRECTION_URL}`
      }
      component = {
        AddDirection
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.UPDATE_DIRECTION_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}/${Constants.UNIQUE_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
        EditDirection
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}${Constants.CREATE_BUILD_NOTE_URL}`
      }
      component = {
        AddBuildNote
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.UPDATE_BUILD_NOTE_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}/${Constants.UNIQUE_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
        EditBuildNote
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}${Constants.CREATE_OVERCLOCKING_NOTE_URL}`
      }
      component = {
        AddOverclockingNote
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.UPDATE_OVERCLOCKING_NOTE_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}/${Constants.UNIQUE_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
      ...
      /> <
      SecuredRoutes exact path = {
        `${Constants.COMPUTER_BUILD_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}${Constants.CREATE_PURPOSE_URL}`
      }
      component = {
        AddPurpose
      }
      /> <
      SecuredRoutes exact path = {
        `${Constants.UPDATE_PURPOSE_URL}${Constants.BUILD_IDENTIFIER_PATH_VARIABLE}/${Constants.UNIQUE_IDENTIFIER_PATH_VARIABLE}`
      }
      component = {
        EditPurpose
      }
