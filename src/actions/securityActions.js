...
export const requestPasswordChange = (history, username) => async (
  dispatch
) => {
  try {
    /*
...
export const changePassword = (token, history, passwordContents) => async (
  dispatch
) => {
  try {
    ...
    await axios
      ...
      .then((response) => {
        ...
        // TODO: look for an efficient way to redirect and keep the state in tact so user is shown the message that the password has changed.
