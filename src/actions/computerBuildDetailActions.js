 ...
 */
export const deleteComputerBuildByBuildIdentifier =
  (buildIdentifier) => async (dispatch) => {
...
export const createObject =
  (object, history, apiURL, computerBuildIdentifier) => async (dispatch) => {
    try {
...
export const deleteObjectById =
  (apiURL, buildIdentifier, uniqueIdentifier, dispatchType) =>
  async (dispatch) => {
    if (
      window.confirm(
...
export const updateObject =
  (object, buildIdentifier, uniqueIdentifier, history, apiURL) =>
  async (dispatch) => {
    try {
      await axios.patch(
        `${apiURL}${buildIdentifier}/${uniqueIdentifier}`,
